%***********************************************************************
%             Simulate QAM Signal with Clock Drift
...
ml=3;                      % Number of modulation levels (BPSK: ml=1, QPSK: ml=2, 16QAM: ml=4)
...
figure(1)
subplot(2,1,1), plot(real(xs(1000:10000)),'b.')        % plot constellation diagram
title('constellation diagram');
subplot(2,1,2), plot(imag(xs(1000:10000)),'b.')        % plot constellation diagram
title('constellation diagram');
